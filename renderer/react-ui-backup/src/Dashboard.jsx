// renderer/react-ui/src/Dashboard.jsx
        ...
        <div className="col-span-3 space-y-4">
          ...
          <DashboardCard title="Quick Stats" className="h-fit">
            <div className="grid grid-cols-2 gap-3 text-center">
              ...
              <div>
                <div className="text-lg font-mono">8.5h</div>
                <div className="text-xs text-gray-400">Focus</div>
              </div>
              <div>
                <div className="text-lg font-mono">92%</div>
                <div className="text-xs text-gray-400">Health</div>
              </div>
              <div>
                <div className="text-lg font-mono">15</div>
